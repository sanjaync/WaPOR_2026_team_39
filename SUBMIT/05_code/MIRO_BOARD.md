...
- **The test sentence:** *Because of this, an MWRI planning officer will direct this season's budget to Kafr El Sheikh, Damietta and Beheira first, instead of splitting it evenly across twenty governorates.*
...
- **Result at $12M: +23% more water than an area-proportional split** — same money, same measures, different order.
- **The number that matters more:** with evaporation held spatially flat, targeting gains **exactly zero**. Every point of the 23% comes from spatial information. About 8 points of it need genuine satellite detail; the rest a coarse agronomic map would give you. *We ran that test on ourselves.*
- **Equity is priced, not ignored.** Reserving 25% of the budget to spread across all twenty governorates still funds every one of them and costs only **3.9%** of the water. That is the recommendation a budget committee can actually sign.
...
> Egypt grows food for 110 million people on a fixed share of the Nile.
>
> Every year the ministry spends a budget modernising farms. IPAT — the tool it already runs — shows where water productivity is low. It doesn't say where to spend.
>
> WaPOR can. It separates water that grew a crop from water that just evaporated off wet soil. Nobody turns that into money.
>
> We rank every governorate by how much evaporated water is recoverable, and what it costs to recover it. Same budget, same measures, different order — about twenty percent more water.
>
> We tested that on ourselves: flatten the map, and targeting gains nothing. All of it is spatial.
>
